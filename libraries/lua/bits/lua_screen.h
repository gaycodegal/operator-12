...
void draw_circle(SDL_Surface* surface, int32_t center_x, int32_t center_y, int32_t radius, Uint32 color);
void fill_circle(SDL_Surface* surface, int32_t center_x, int32_t center_y, int32_t radius, Uint32 color);
